<?php
class TestPackages extends Controller
{
      ...
      if ($_SERVER['REQUEST_METHOD'] == 'POST')
      {
         ...
         if ($_POST['action'] == "addpackage")
         {
            ...
            )
            {
               ...
               redirect('TestPackages/viewAllPackages');
            ...
            else
            {
               ...
               $this->view('admin/test-add-packages', $result);
            }
         }
         else
         {
   ...
   public function fetchPrices(){
      ...
      $tableName = '';
         if ($_POST['spType'] === 'band') {
            $tableName = 'bandservicedetails';
         } elseif ($_POST['spType'] === 'photo') {
            $tableName = 'photoservicedetails';
         } elseif ($_POST['spType'] === 'deco') {
            $tableName = 'decoservicedetails';
         }
         echo "<script>console.log(" . json_encode($serviceId) . ");</script>";
      $result = $this->packageModel->getPriceByServiceId($serviceId, $providerId, $tableName);
