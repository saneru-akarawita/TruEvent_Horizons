...
<html lang="en">
    <head>
        ...
        <title>TruEvent Horizons - Payment Details - Admin</title>
    ...
    <div class="table-container" style="border-radius:10px">
        <h1 style="font-size:50px; margin-top:75px;"><center>SYSTEM PAYMENT LOG</center></h1>
            ...
            <tbody>
                <?php foreach($data[0] as $paymentLogs):?>
                    ...
                    <tr>
                        ...
                        <td><?=$paymentLogs->Status_Message?></td>
                    </tr>
                <?php endforeach;?>
            </tbody>
        </table>
