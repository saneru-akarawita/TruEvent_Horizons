...
<head>
    ...
    <title>TruEvent Horizons - Band Header</title>
        ...
        <img src="<?php echo URLROOT ?>/public/images/hotel manager/figma images/logo designs/logo2.jpg" alt="logo" class="logo">
                ...
                <div class="menu-bar">
                        <ul>
                                ...
                                <li style="margin-left:400px;"><a href="home">Home</a>
                                ...
                                <li><a href="<?php echo URLROOT ?>/BandDashboard/chat"> <i class="fa-solid fa-comment" style="margin-left:-70px;"></i></a></li>
                                <!-- </div> -->  
                                <li class="nr_li dd_main">
                                        ...
                                        <div class="sub-menu1">
                                                <ul>
                                                        <li><i class="fa-solid fa-gear"></i><a href="<?php echo URLROOT ?>/BandDashboard/profileSettings">Profile Settings</a></li>
                                ...
                                <hr size="1px">
                                <p style="margin-top:40px; margin-left:-103px;width:max-content"><?= Session::getUser('typeText') ?></p> 
                        </ul>
