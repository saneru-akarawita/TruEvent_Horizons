...
<section class="packages">
    ...
    <?php foreach ($data as $bsDetails) : ?>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3 style="font-size:medium">Most Appropriate for <?= $bsDetails->service_name; ?> </h3>
                ...
                <button class="deleteButton"><a href="deleteService?service_id=<?=$bsDetails->service_id; ?>"  name="deleteaction" value="delete" style="color:white; font-weight:550;">Delete</a></button>
            </div>
        </div>
        <?php } else { ?>
