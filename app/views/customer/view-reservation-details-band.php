                                                        ...
                                                        <?php foreach ($servicedetails as $servicedata) : ?>
                                                                ...
                                                                <div class="description">
                                                                        <table id="details12">
                                                                                        ...
                                                                                        <tr>
                                                                                                <td>Band Type </td>
                                                                                                <td>: <?= $servicedata->band_type;?></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                                <td>No of Players </td>
                                                                                                <td>: <?= $servicedata->no_of_players;?></td>
                                                                                        </tr>
                                                                                
                                                                                        <tr>
                                                                                                <td>Other Features </td>
                                                                                                <td>:<?php if(empty($servicedata->other_band_type)) echo " None"; else  echo $servicedata->other_band_type; ?> </td>
