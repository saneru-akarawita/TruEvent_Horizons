...
<head>
   ...
   <title>TruEvent Horizons - Customer - Advance Payment Success</title>
</head>
...
<?php require APPROOT . "/views/customer/header-customer.php" ?>
   ...
   <div class="main-container">
      ...
      <div class="container-displaymsg">
        <h2>Successfully completed Advance Payment!</h2>
        <img src="<?php echo URLROOT ?>/public/images/images-UI/success.gif" alt="success icon">
      </div>
   </div>

   <button class="totalpay">Complete Total Payment</button>
