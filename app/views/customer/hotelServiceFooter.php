   ...
   <div class="content-sp">
          ...
          <div class="left box">
                <div class="upper-div">
                        ...
                        <p>We are provding a premium destination for travelers seeking comfort.
                        We offer exceptional service to guests with a focus on comfort and convenience.Our commitment to customer satisfaction and luxury amenities creates a memorable and enjoyable 
                        stay for all.</p>
                </div>
                <div class="lower-div">
          ...
          <div class="middle box">
            ...
            <div><a href="#">Banquet halls and meeting rooms</a></div>
            <div><a href="#">Spa and wellness services</a></div>
            <div><a href="#">Catering</a></div>
            <div><a href="#">Transportation and Parking</a></div>
            <div><a href="#">High Security</a></div>
            <div><a href="#">Business center</a></div>
          </div>
