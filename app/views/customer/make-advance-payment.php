...
<head>
   ...
   <!-- <link rel="stylesheet" href="<?php echo URLROOT ?>/public/css/hotel manager/style4.css" /> -->
   ...
   <div class="main-container">
      ...
      <div class="ser-container form-container contentBox">
         <form action="#" method="post" class="form">
            <h1 class="title">Make Advance Payment</h1>
        ...
        <div class="row">
             ...
             <div class="text-group">
              ...
              <div class="text-group">
                <label class="label" for="offers/promotions">Do you have offers/promotions</label>
                <select name = "checkoffers" class="dropdownmenu" id="checkoffers"> 
                ...
                <div class="text-group">
                        <label class="label" for="price" id="offercodelabel" >Offers/Promotion Code</label>
                        <input type="text" name="price" placeholder="Enter promo code" maxlength="25" id="offercodeinput">
