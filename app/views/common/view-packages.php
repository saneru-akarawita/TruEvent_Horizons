...
<html lang="en">
    <head>
        ...
        <title>TruEvent Horizons - View Packages</title>
        ...
        <section class="packages">
            ...
            <div class="box-container">
                ...
                <?php foreach ($data as $pDetails) : ?>
                    ...
                    <div class="box" style="border-color:white; border-radius:10px 10px 10px 10px">
                        <div class="image" style="border-radius:10px 10px 10px 10px">
                        ...
                        <div class="content">
                            ...
                            <p style="font-size:small" >Plan your <?= $pDetails->package_type; ?> </p><br>
                                <button class="viewButton"  style="margin-left:-4px;  width:150px; background-color:black"><a href="viewEachPackage?package_id=<?=$pDetails->package_id; ?>"  name="viewaction" value="view" style="color:white; font-weight:550;">View Package</a></button>
                        </div>
                    </div>
                    <?php } else { ?>
                <div class="box" style="height: 400px; border-color:white; border-radius:10px 10px 10px 10px">
                ...
                <h3 style="font-size:medium"><?= $pDetails->package_name; ?> </h3>
                    ...
                    <button class="viewButton" style="height:40px; width:200px; background-color:grey" >Package Unavailable</a></button>
