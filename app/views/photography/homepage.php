...
<head>
    ...
    <title>TruEvent Horizons - Home - Photography</title>
...
<!-- <section class="home-packages">
    ...
    <div class="box-container">
        <div class="box">
            <div class="image">
                <img src="<?php echo URLROOT ?>/public/images/admin-add-packages/image4.jpg" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
            <div class="image">
                <img src="<?php echo URLROOT ?>/public/images/admin-add-packages/image5.jpg" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
            <div class="image">
                <img src="<?php echo URLROOT ?>/public/images/admin-add-packages/image6.jpg" alt="">
            </div>
            <div class="content">
