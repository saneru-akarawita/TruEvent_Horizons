...
<head>
    ...
    <title>TruEvent Horizons - Serivces List -  Photography</title>
    ...
    <?php foreach ($data as $psDetails) : ?>
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <button class="deleteButton"><a href="deactivate?service_id=<?=$psDetails->service_id; ?>"  name="deleteaction" value="delete" style="color:white; font-weight:550;">Disable</a></button>
            </div>
        </div>
        <?php } else { ?>
                <div class="box">
